...
def main():
    ...
    #Zostawia tylko kolumny z liczbą odczytów dla poszczególnych próbe
    ...
    #Pozwala to uzyskać czytelny wykres skupiony na kluczowych genach
    ...
    if df_log.shape[1] > 1:
        #Jeśli próbek jest więcej niż jedna stosuje klastrowanie hierarchiczne
